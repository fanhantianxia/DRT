function [data_z] = wb_rest_rerefer_cm(data,G,leftelec,rightelec,Aelec)
...
%         leftelec: index of left electrodes excluding left mastoid. e.g. [1:2:16]
%         rightelec: index of right electrodes excluding right mastoid. e.g. [2:2:16]
%         Aelec: index of mastoids [A1,A2] or [A2,A1]. e.g. [17,18] 
